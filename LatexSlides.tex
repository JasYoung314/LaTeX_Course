...
\only<1>{\begin{center}\includegraphics[width=10cm]{Compile_Cycle.pdf}\end{center}}
\only<2>{\begin{center}\includegraphics[width=10cm]{Write_Cycle.pdf}\end{center}}
\only<3,17>{\begin{center}\includegraphics[width=10cm]{Compile_Cycle.pdf}\end{center}}
\only<4,18>{\begin{center}\includegraphics[width=10cm]{View_Cycle.pdf}\end{center}}
\only<5>{\begin{center}\includegraphics[width=10cm]{Broken_Cycle.pdf}\end{center}}
\only<6,9,12,15>{\begin{center}\includegraphics[width=10cm]{Write_Broken_Cycle.pdf}\end{center}}
\only<7,10,13,16>{\begin{center}\includegraphics[width=10cm]{Compile_Broken_Cycle}\end{center}}
\only<8,11,14>{\begin{center}\includegraphics[width=10cm]{Broken_Cycle.pdf}\end{center}}
}
